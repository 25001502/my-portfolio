...
const Footer = () => {
  return (
    <section id="Footer">
      <footer className="footer sm:footer-horizontal  border-t-[#FF3154] border border-black text-neutral-content p-10  bg-[radial-gradient(circle_at_top_left,#ffffff08_30%,transparent_31%),radial-gradient(circle_at_bottom_right,#ffffff08_30%,transparent_31%)] bg-size-[6em_6em]">
          ...
          <div className="grid grid-flow-col gap-4">
            <a  title="Twitter">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-[#FF3154]"
              >
